...
public class CodeGenerator {
    public static void main(String[] args) {
        // 包名+模块
        String packageName = "com.jiubo.buildstore";
        boolean serviceNameStartWithI = false;//auth -> UserService, 设置成true: auth -> IUserService
        //把需要自动生成的表 放在这里!!
        generateByTables(serviceNameStartWithI, packageName, "swd", "boot", "commercial_activitie");
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String author, String database, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://172.16.6.78:3306/authenticity?useSSL=false&useUnicode=true&characterEncoding=utf8&allowMultiQueries=true&useTimezone=true&serverTimezone=GMT%2B8&zeroDateTimeBehavior=convertToNull";

...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        //把需要自动生成的表 放在这里!!
        generateByTables(serviceNameStartWithI, packageName, "dx", "boot", "metro_build_ref");
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String author, String database, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://172.16.6.78:3306/buildstore?useSSL=false&useUnicode=true&characterEncoding=utf8&allowMultiQueries=true&useTimezone=true&serverTimezone=GMT%2B8&zeroDateTimeBehavior=convertToNull";
